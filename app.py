...
class Upload:
    def POST(self):
        ...
        # Usar el prompt fijo
        prompt = "Contesta esto como un chat psicologo profecional especializado en combatir adicciones y da un posible analisis psicológico, tu nombre es Amigo y da una respuesta corta de 50 a 80 palabras y detallada en español:"
